    ...
    <div className='movies-card card'>
      <div className="card__container">
        ...
        <a href={movie.trailerLink} target='_blank' rel="noreferrer">
          <img src={movie.image.url ? `https://api.nomoreparties.co${movie.image.url}` : movie.image} alt="Movie img"
               className="card__img flip-in-diag-1-tr"/>
        </a>
        ...
        {pathname === '/saved-movies' &&
          <button className='button button_type_remove' type='button' onClick={handleDeleteMovies}>&#10006;</button>}
      </div>
    </div>
  );
}
